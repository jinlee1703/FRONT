...
public class FarmController {
    ...
    @GetMapping("/{id}")
    public String getFarm(@PathVariable("id") Long id, Model model, @CookieValue(name = "isSeller") Boolean isSeller, @RequestParam(name = "page", required = false) Long page, @RequestParam(name = "size", required = false) Long size) {
